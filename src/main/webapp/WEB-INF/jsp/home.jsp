	...
	<div class="page-sidebar navbar-collapse collapse">
		...
		<ul class="page-sidebar-menu">
			...
			<li class="">
				...
				<ul class="sub-menu">
					<li>
						<a class="" href="${APP_PATH}/page/forword?url=admincustomer">客户信息管理</a>
					</li>
				</ul>
			</li>
			<li class="">
				...
				<ul class="sub-menu">
					<li>
						<a class="" href="${APP_PATH}/page/forword?url=adminpublisher">出版社管理</a>
					</li>
				</ul>
			</li>
			<li class="">
				...
				<ul class="sub-menu">
					<li>
						<a class="" href="${APP_PATH}/page/forword?url=adminorder">订单管理</a>
					</li>
				</ul>
			</li>
			<li class="">
				...
				<ul class="sub-menu">
					<li>
						<a class="" href="${APP_PATH}/page/forword?url=adminbook">书籍管理</a>
					</li>
				</ul>
			</li>
		</ul>
